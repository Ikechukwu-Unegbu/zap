...
<rect width="48" height="48" fill="white"/>
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="#" class="text-gray-600 hover:text-blue-500">Learn</a>
                </div>

                <!-- Mobile Menu Button -->
                <div class="md:hidden">
                    <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
